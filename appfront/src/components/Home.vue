        ...
        <el-container>
            ...
            <el-main>
                <template v-if="showTable === 'TechTable'">
                    <template>
                        <el-radio v-model="radio1" label="1">待标注</el-radio>
                                        ...
                                        <el-table-column width="150" label="操作" align="center">
                                            <template slot-scope="scope">
                                                <el-button size="mini" type="primary">
                                                    <a target="_blank" rel="noopener noreferrer" :href="scope.row.link" style="color:#fff;text-decoration:none">查看</a>
                                                </el-button>
                                            </template>
                                        </el-table-column>
                                    ...
                                    <el-table :data="patentData" :highlight-current-row="true" max-height="250">
                                        ...
                                        <el-table-column width="150" label="操作" align="center">
                                            <template slot-scope="scope">
                                                ...
                                                <el-button size="mini" type="primary"><a target="_blank" rel="noopener noreferrer" :href="scope.row.link" style="color:#fff;text-decoration:none">查看</a></el-button>
                                            </template>
                                        </el-table-column>
                                    </el-table>
                ...
                <template v-else-if="showTable === 'CompanyTable'">
                    <template>
                        <el-radio v-model="radio2" label="1">待标注</el-radio>
                        <el-radio v-model="radio2" label="2">所有</el-radio>
                    </template>
                ...
                <template v-else-if="showTable === 'RelationTable'">
                    <template>
                        <el-radio v-model="radio3" label="1">待标注</el-radio>
                        <el-radio v-model="radio3" label="2">所有</el-radio>
                    </template>
