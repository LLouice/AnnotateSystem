...
urlpatterns = [
    ...
    path(r'news_company_list_ajax/<kw>',
         views.news_company_list_ajax, name="news_company_list_ajax"),
    path(r'news_tech_list_ajax/<kw>',
         views.news_tech_list_ajax, name="news_tech_list_ajax"),
    path(r'patent_list_ajax/<kw>',
         views.patent_list_ajax, name="patent_list_ajax"),
    path(r'keywords_company/delete/<kw>',
         views.keywords_company_delete_ajax, name="keywords_company_delete_ajax"),
    path(r'keywords_tech/delete/<kw>',
         views.keywords_tech_delete_ajax, name="keywords_tech_delete_ajax"),
